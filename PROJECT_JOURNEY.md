...
## 🧭 Recent Debugging Timeline (2025-12-22 → 2025-12-23)
...
-   Lock dependency versions earlier (Spark, Hadoop, Delta Lake, AWS SDK)
...
-   Introduce preflight validation checks for S3A, Kafka, and Spark configs.
